...
const benefits = [
  {
    ...
    description: 'Stone-ground mills operate under ~40°C while traditional chakki mills reach 120–150°C.',
    details: 'Heat destroys Vitamin B1, B2, B3 & folate. Our stone-grinding technology preserves up to 98% of these essential nutrients.',
    citation: 'Food Chemistry Journal, 2018',
  },
  {
    icon: <Wheat className="h-8 w-8" />,
    title: 'Better Fiber Integrity',
    description: 'Stone-grinding preserves the natural fiber structure of wheat grains.',
  ...
  },
  {
    ...
    details: 'Stone-ground atta keeps the starch structure natural, resulting in slower sugar release. This makes it ideal for diabetics and weight management.',
    citation: null,
  },
  {
    ...
    details: 'Chakki heat causes oxidation and loss of natural oils. Stone-grinding retains these heart-healthy compounds that support overall wellness.',
    citation: null,
  },
  {
    icon: <Wind className="h-8 w-8" />,
    title: 'No Burnt Aroma',
    description: 'Stone-ground atta has a clean, fresh, and natural aroma.',
  ...
  },
  {
    ...
    details: 'Stone-ground atta stays fresh for 4-6 months without any preservatives, compared to 2-3 months for regular chakki atta.',
    citation: null,
  },
  {
    ...
    <div>
      <section className="bg-gradient-to-b from-wheat/20 to-background py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-heading text-3xl md:text-5xl font-bold mb-4" data-testid="text-benefits-title">
            The Science Behind Stone-Ground Atta
          </h1>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Discover why our stone-grinding process produces healthier, more nutritious atta 
      ...
      <section className="py-16 container mx-auto px-4">
        <h2 className="font-heading text-2xl md:text-3xl font-bold text-center mb-12">
          7 Science-Backed Benefits of Stone-Ground Atta
        </h2>
      ...
      <section className="py-16 container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-8">
            Stone-ground atta isn't just a marketing term – it's a scientifically superior 
