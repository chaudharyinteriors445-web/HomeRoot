...
export const products: Product[] = [
  {
    ...
    description: 'Our Khapli (Emmer) Wheat Atta is stone-ground from ancient emmer wheat grains, known for their superior nutritional profile. This heritage grain has been cultivated for over 10,000 years and offers a nutty, earthy flavor perfect for traditional rotis.',
    price: 220,
    priceUnit: 'per kg',
    image: khapliWheatImage,
    category: 'ancient-grain',
    badges: ['Stone-Ground', 'Ancient Grain', 'Low GI'],
    healthBenefits: [
  ...
  },
  {
    ...
    description: 'Our Whole Wheat Atta is stone-ground from carefully selected wheat grains, preserving all the natural goodness of the bran, germ, and endosperm. Perfect for everyday rotis with superior taste and nutrition.',
    price: 90,
    priceUnit: 'per kg',
    image: wholeWheatImage,
    category: 'whole-wheat',
    badges: ['Stone-Ground', 'Stone-Ground', '100% Organic'],
    healthBenefits: [
  ...
  },
  {
    ...
    description: 'Our Multigrain Atta combines seven carefully selected grains - wheat, oats, barley, ragi, jowar, bajra, and maize. Stone-ground to retain maximum nutrients, this flour offers a complete nutritional profile for health-conscious families.',
    price: 130,
    priceUnit: 'per kg',
    image: multigrainImage,
    category: 'whole-wheat',
    badges: ['Stone-Ground', '7 Grains', 'High Fiber'],
    healthBenefits: [
  ...
  },
  {
    ...
    description: 'Our Bajra (Pearl Millet) Atta is stone-ground from organically grown bajra grains. This ancient millet is a powerhouse of nutrition, especially popular in winter months for its warming properties and exceptional mineral content.',
    price: 150,
    priceUnit: 'per kg',
    image: bajraImage,
    category: 'millet',
    badges: ['Stone-Ground', 'Millet', 'Gluten-Free'],
    healthBenefits: [
  ...
  },
  {
    ...
    description: 'Our Jowar (Sorghum) Atta is stone-ground from premium quality jowar grains. This versatile millet flour is packed with antioxidants and is perfect for making soft, nutritious rotis that the whole family will love.',
    price: 120,
    priceUnit: 'per kg',
    image: jowarImage,
    category: 'millet',
    badges: ['Stone-Ground', 'Millet', 'High Antioxidants'],
    healthBenefits: [
  ...
  },
  {
    ...
    description: 'Our Ragi (Finger Millet) Atta is stone-ground from nutrient-dense ragi grains. Known as a superfood, ragi is exceptionally high in calcium and is excellent for growing children, pregnant women, and the elderly.',
    price: 150,
    priceUnit: 'per kg',
    image: ragiImage,
    category: 'millet',
    badges: ['Stone-Ground', 'Millet', 'High Calcium'],
    healthBenefits: [
